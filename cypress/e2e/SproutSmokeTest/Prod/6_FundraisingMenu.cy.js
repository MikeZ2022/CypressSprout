...
describe('SproutSmokeTest',()=>{
    beforeEach(() => {
      ...
      it('1.6 Fundraising Menu items check',()=>{
        ...
        cy.get(':nth-child(1) > .ant-input-group-wrapper > .ant-input-wrapper > .ant-input')
          .click()
          .wait(1000)
          .type(1000000)
        cy.get(':nth-child(2) > .ant-input-group-wrapper > .ant-input-wrapper > .ant-input')
          .click()
          .wait(1000)
          .type(1)
        cy.get(':nth-child(3) > .ant-input-group-wrapper > .ant-input-wrapper > .ant-input')
          .click()
          .wait(1000)
          .type(2000000)
