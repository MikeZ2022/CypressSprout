 ...
 describe('SproutSmokeTest',()=>{
  ...
  cy.get('[data-row-key="8559"] > .ant-table-cell-fix-right > .ant-dropdown-trigger').click()
  ...
  cy.get('[data-row-key="8559"] > .ant-table-selection-column > .ant-checkbox-wrapper > .ant-checkbox').click()
